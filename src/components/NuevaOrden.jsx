...
import { Header, Table, Dropdown, TextArea } from 'semantic-ui-react';
...
export default class NuevaOrden extends Component {
		...
		this.setState({
			...
			this.setState ({
				...
				.catch((error) => {
					...
					linedet = {id:1,  formula_id:0,item_bundle_name:"",quantity:0,cantidad:0}
						detalle.push(linedet)
						this.setState({
							detalle:detalle,
							guardarcantidad:this.guardarcantidad,
	...
	render() {
		...
		items = [items,...itemst]
		let {
			guardarcantidad,equipos, action, Selectequipo, Selectempleado, equipo_id, empleados, empleado, detalle, item_id, Formulas, from_orden
